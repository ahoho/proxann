...
MODEL_TYPE="gpt-4o-mini-2024-07-18" #"gpt-4o-2024-08-06" #"gpt-4o-2024-08-06" #"qwen:32b" #"qwen:32b" #"llama3.3:70b" #"llama3.1:8b-instruct-q8_0" #,llama3.3:70b,qwen:32b
PROMPT_MODE="q1_then_q2_mean,q1_then_q3_mean"
...
TM_MODEL_DATA_PATHS=(
  "data/json_out/config_wiki_part1.json,data/json_out/config_wiki_part2.json"
  "data/json_out/config_bills_part1.json,data/json_out/config_bills_part2.json"
)
RESPONSE_CSV_PATHS=(
